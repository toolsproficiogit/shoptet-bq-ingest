...
You will see the **Service URL** printed in the Cloud Shell. Alternatively, you can check it in Cloud Console, if you navigate to Cloud Run > Services > load-csv-to-bigquery (your chosen service name) > URL is displayed at the top. It should have a format like this: https://<YOUR-SERVICE-NAME>-123456789.<YOUR-SERVICE-REGION>.run.app
